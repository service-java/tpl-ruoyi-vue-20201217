...
import com.ruoyi.common.util.DictUtils;
import com.ruoyi.common.util.StringUtils;
import com.ruoyi.common.util.reflect.ReflectUtils;
...
public class ExcelUtils<T> {
     ...
     * @return 结果
     */
    public ResultVo exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public ResultVo importTemplateExcel(String sheetName) {
